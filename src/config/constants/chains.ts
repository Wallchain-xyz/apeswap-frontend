...
export enum SupportedChainId {
  ...
  MATIC = ChainId.MATIC,
  MATIC_TESTNET = ChainId.MATIC_TESTNET,
  TLOS = ChainId.TLOS,
...
export const NETWORK_ICONS: Partial<Record<ChainId, icons>> = {
  ...
  [ChainId.MATIC]: icons.POLYGON_TOKEN,
...
// Network RPC nodes
export const NETWORK_RPC: Record<ChainId, string[]> = {
  [ChainId.BSC]: [
...
export const RPC_PROVIDERS: Record<ChainId, StaticJsonRpcProvider> = {
  [ChainId.MAINNET]: new StaticJsonRpcProvider(NETWORK_RPC[ChainId.MAINNET][0]),
  [ChainId.MATIC]: new StaticJsonRpcProvider(NETWORK_RPC[ChainId.MATIC][0]),
  [ChainId.BSC]: new StaticJsonRpcProvider(NETWORK_RPC[ChainId.BSC][0]),
  [ChainId.TLOS]: new StaticJsonRpcProvider(NETWORK_RPC[ChainId.TLOS][0]),
  [ChainId.BSC_TESTNET]: new StaticJsonRpcProvider(NETWORK_RPC[ChainId.BSC_TESTNET][0]),
  [ChainId.MATIC_TESTNET]: new StaticJsonRpcProvider(NETWORK_RPC[ChainId.MATIC_TESTNET][0]),
...
export const WALLCHAIN_PARAMS: Partial<
  Record<
    ChainId,
    Partial<Record<SmartRouter, { apiUrl: string; apiKey: string }>>
  >
> = {
  [ChainId.BSC]: {
    [SmartRouter.APE]: {
...
export const SMART_PRICE_GETTERS: Partial<
  Record<ChainId, Partial<Record<SmartRouter, string>>>
> = {
  [ChainId.BSC]: {
...
export const SMART_LP_FEES: Partial<
  Record<ChainId, Partial<Record<SmartRouter, number>>>
> = {
  [ChainId.BSC]: {
    [SmartRouter.APE]: 20,
...
export const CHAIN_BLOCKS_PER_YEAR: Partial<Record<ChainId, BigNumber>> = {
  [ChainId.BSC]: BigNumber.from(10512000),
  [ChainId.MATIC]: BigNumber.from(13711304),
  [ChainId.MAINNET]: BigNumber.from(2628000),
  [ChainId.TLOS]: BigNumber.from(63072000),
};
...
export const AVAILABLE_CHAINS_ON_LIST_VIEW_PRODUCTS: Record<
  LIST_VIEW_PRODUCTS,
  ChainId[]
> = {
...
export const FULL_PRODUCT_NAMES: Record<
  LIST_VIEW_PRODUCTS | OTHER_PRODUCTS,
  string
> = {
...
> = {
  ...
  [ChainId.MAINNET]: {
    graphAddress:
      "https://api.thegraph.com/subgraphs/name/apeswapfinance/ethereum-dex",
  ...
  [ChainId.TLOS]: {
    graphAddress:
      "https://telos.apeswapgraphs.com/subgraphs/name/ape-swap/apeswap-graph",
    explorer: BLOCK_EXPLORER[ChainId.TLOS],
    blockGraph:
      "https://telos.apeswapgraphs.com/subgraphs/name/ape-swap/telos-blocks",
