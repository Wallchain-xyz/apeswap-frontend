            ...
            <Flex sx={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
              <Flex
                sx={{
                  ...
                  width: '55px',
                  borderRadius: '10px',
                  background: userSlippageTolerance.toFixed(2) === '0.10' ? 'yellow' : 'white3',
                  alignItems: 'center',
              ...
              <Flex
                sx={{
                  ...
                  width: '55px',
                  borderRadius: '10px',
                  background: userSlippageTolerance.toFixed(2) === '0.50' ? 'yellow' : 'white3',
                  alignItems: 'center',
                  justifyContent: 'center',
                  cursor: 'pointer',
                }}
              ...
              <Flex
                sx={{
                  ...
                  width: '55px',
                  borderRadius: '10px',
                  background: userSlippageTolerance.toFixed(2) === '1.00' ? 'yellow' : 'white3',
                  alignItems: 'center',
                  justifyContent: 'center',
                  cursor: 'pointer',
                }}
