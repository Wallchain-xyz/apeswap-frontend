...
const CTA_CARDS = {
  'circular-sell': {
    0: <CTACard type={CTA_TYPE.MAXIMIZERS} action={MODAL_TYPE.SELLING} key={0} />,
  ...
  'circular-buy': {
    0: <CTACard type={CTA_TYPE.MAXIMIZERS} action={MODAL_TYPE.BUYING} key={0} />,
    1: <CTACard type={CTA_TYPE.POOLS} action={MODAL_TYPE.BUYING} key={1} />,
    2: <CTACard type={CTA_TYPE.GNANA} action={MODAL_TYPE.BUYING} key={2} />,
  },
  'circular-gh': {
    0: <CTACard type={CTA_TYPE.MAXIMIZERS} action={MODAL_TYPE.GENERAL_HARVEST} key={0} />,
  ...
  'circular-ph': {
    ...
    1: <CTACard type={CTA_TYPE.MAXIMIZERS} action={MODAL_TYPE.POOL_HARVEST} key={1} />,
