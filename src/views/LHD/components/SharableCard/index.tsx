...
const SharableCard = ({
  ...
  function share() {
    ...
    if (navigator.share) {
        ...
        .share({
          ...
          url:
            tokenAddresses && tokenAddresses[0]
              ? `/liquidity-health/56/${tokenAddresses[0].address}`
              : 'Apeswap.Finance/liquidity-health/',
        })
      ...
      const url =
        tokenAddresses && tokenAddresses[0]
          ? `Apeswap.Finance/liquidity-health/56/${tokenAddresses[0].address}`
          : 'Apeswap.Finance/liquidity-health/'
  ...
  return (
    ...
    >
      ...
      <Flex>
        <Button sx={{ m: '20px' }} onClick={handleDownloadClick}>
          Download Image
        </Button>
        <Button sx={{ m: '20px' }} onClick={handleShareClick}>
          Share
        </Button>
      </Flex>
