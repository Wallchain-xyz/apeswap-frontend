  ...
  return (
    <Flex sx={styles.contributorCont}>
      ...
      <Flex sx={styles.btnCont}>
        <Button onClick={() => window.open('https://apeswap.gitbook.io/apeswap-finance/welcome/master', '_blank')} variant='secondary'
                sx={{ ...styles.btn, m: ['0 0 10px 0', '0 0 10px 0', '0 0 10px 0', '0 20px 0 0'] }}>
          {t('LEARN MORE')}
        </Button>
        <Button onClick={() => window.open('https://github.com/ApeSwapFinance/lhd-config', '_blank')} sx={{ ...styles.btn, width: ['100%', '100%', '100%', '215px'] }}>
