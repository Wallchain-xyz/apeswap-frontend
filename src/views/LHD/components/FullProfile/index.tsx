...
import { Button, Flex, Link, Svg, Text } from '../../../../components/uikit'
            ...
            <Flex sx={{ width: '100%' }}>
              <Flex sx={{ width: '100%', flexDirection: 'column' }}>
                ...
                <Flex sx={{ width: '100%', alignItems: 'center', mt: '10px' }}>
                  <Flex sx={{width: '50px', height: '20px', background: 'linear-gradient(0deg, rgba(253, 251, 245, 0.5), rgba(253, 251, 245, 0.5)), #FFB300', alignItems: 'center', justifyContent: 'center', borderRadius: '4px'}}>
