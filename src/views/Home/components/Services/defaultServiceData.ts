...
export const defaultServiceData: (t: ContextApi['t']) => DefaultServiceData[] = (t) => [
  {
    ...
    backgroundImg: '/images/homepage/homepage-pools',
    link: '/pools',
    stats: [],
  },
  {
    ...
    backgroundImg: '/images/homepage/homepage-farms',
    link: '/farms',
    stats: [],
  },
  {
    ...
    backgroundImg: '/images/homepage/homepage-lending',
  ...
  },
  {
    ...
    backgroundImg: '/images/homepage/homepage-bills',
    link: '/treasury-bills',
    stats: [],
  },
]
