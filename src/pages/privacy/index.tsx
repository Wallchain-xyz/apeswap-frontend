  ...
  return (
    <PageContainer>
      <Flex sx={{ flexDirection: 'column', marginBottom: '100px' }}>
        ...
        <Text sx={styles.heading}>I. Name and address of the Data Manager:</Text>
        <Text as="p" variant="sm" sx={styles.text}>
          ApeSwap Foundation, Suite 102, Cannon Place, P.O. Box 712, North Sound Rd., Grand Cayman, KY1-9006.
        </Text>
        <Text sx={styles.heading}>II. Name and address of the Data Processing Manager:</Text>
        <Text as="p" variant="sm" sx={styles.text}>
          The entity in charge of data processing and protection of information gathered in the Site is ApeSwap
          Foundation.
        </Text>
        <Text sx={styles.heading}>III. Processed data and management of personal data:</Text>
        <Text as="p" variant="sm" sx={styles.text}>
        ...
        <Text sx={styles.heading}>IV. Legal basis for the processing of personal data:</Text>
        <Text as="p" variant="sm" sx={styles.text}>
        ...
        <Text sx={styles.heading}>V. Information ApeSwap Collects from you:</Text>
        <Text as="p" variant="sm" sx={styles.text}>
        ...
        <Text sx={styles.heading}>VI. Information collected by third parties:</Text>
        ...
        <Text sx={styles.heading}>VII. Purpose of data processing:</Text>
        <Text as="p" variant="sm" sx={styles.text}>
        ...
        <Text sx={styles.heading}>VIII. Duration of storage and deletion of data:</Text>
        <Text as="p" variant="sm" sx={styles.text}>
        ...
        <Text sx={styles.heading}>IX. Communication and data transfer:</Text>
        <Text as="p" variant="sm" sx={styles.text}>
        ...
        <Text sx={styles.heading}>X. Limited Right to Use:</Text>
        <Text as="p" variant="sm" sx={styles.text}>
        ...
        <Text sx={styles.heading}>XI. Confidentiality:</Text>
        <Text as="p" variant="sm" sx={styles.text}>
        ...
        <Text sx={styles.heading}>XIII. Procedure:</Text>
        <Text as="p" variant="sm" sx={styles.text}>
